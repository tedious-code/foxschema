...
export interface ConnectionOptions {
  ...
  database?: string;
  schema?: string;
  /** Whether this database requires a schema/namespace (Postgres/DB2 do, MySQL doesn't). */
...
export interface ProviderConnectionSettings {
  ...
  /** Does this dialect use a schema/namespace? Drives whether the UI requires one. */
  schemaRequired: boolean;
