 ...
 * cross-dialect migration in Fox today — derived from the actual generator/
...
export const CROSS_DIALECT_READINESS: ObjectTypeReadiness[] = [
  ...
  { objectType: 'Check Constraint', level: 'none', note: 'Not read or migrated by Fox at all yet, on any dialect.' },
