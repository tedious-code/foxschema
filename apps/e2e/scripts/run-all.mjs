...
const ALWAYS = [
  {
    key: 'sql-editor',
    file: 'src/tests/sql-editor-smoke.test.ts src/tests/sql-editor-sqlite.test.ts src/tests/sql-editor-blueprint.test.ts src/tests/sql-editor-copy-export.test.ts',
    label: 'SQL Editor',
  },
  ...(configured.length
    ? [
