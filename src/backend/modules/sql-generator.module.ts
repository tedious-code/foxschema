...
export interface SchemaMapping {
  /** Schema the objects were read from (e.g. HUY). */
  sourceSchema?: string;
  /** Schema the migration deploys into (e.g. VLAD). */
  targetSchema?: string;
}
...
export class SqlGeneratorModule {
   ...
   * schema it was read under (often the connection user's, e.g. CARTER) and
